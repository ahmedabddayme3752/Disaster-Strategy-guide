...
- [ ] **Zone 2 Pleniged** → Source 34:3306 ⏳ (Bloqué par Pare-Feu Réseau)
- [ ] **Zone 3 Pleniged** → Source 34:3306 ⏳ (Bloqué par Pare-Feu Réseau)
...
- [x] `pleniged_windows_dr_guide.md` — Procédure Pleniged Windows 5.7 ✅

---

## ⏳ Phase 6 — Prochaines Étapes (Pleniged)
- [x] Exporter la base `plenesgi_ged` depuis Windows (.34) (Taille 949MB) ✅
...
| **Pleniged Replication** | ⏳ Pare-feu Réseau | ⏳ Pare-feu Réseau |
