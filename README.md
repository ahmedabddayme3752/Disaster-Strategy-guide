...
| Base | Description | Tables | Taille |
|:---|:---|:---:|:---:|
| **`click`** | **Production Réelle Click** | 94 | 73 Mo |
| **`clickTest`** | Copie de test Production | 94 | 19 Mo |
| **`clickTestPub`** | Base de test Publique | — | — |
| **`mail_otp`** | Codes OTP et Validations mail | — | — |
